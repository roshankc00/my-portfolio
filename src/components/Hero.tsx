...
const Hero = () => {
  return (
    <section
      id="home"
      className="min-h-screen flex items-center justify-center bg-gradient-to-r from-gray-800 to-gray-900 text-white"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-4">
          <span className="block">Hi, I'm Roshan Karki</span>
          <span className="block text-blue-400 mt-2">Full Stack Engineer</span>
        </h1>
        <p className="mt-3 text-base sm:text-lg md:text-xl max-w-md mx-auto">
          Specializing in building robust and scalable web solutions with modern
          technologies.
        </p>
