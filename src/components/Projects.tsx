        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white p-4 rounded-lg shadow-md">
            <h5 className="font-semibold text-lg mb-3 text-green-600 flex items-center gap-2">
              <FaChalkboardTeacher className="text-green-500" /> Instructor
              Portal
            </h5>
            <ul className="space-y-2">
  ...
  const projects: Project[] = [
    {
      ...
      description:
        "A unique dating app that matches five male users with one female user in real-time chat rooms, featuring advanced matchmaking algorithms and WebSocket-based communication.",
      ...
      technologies: [
        ...
        {
          name: "WebSocket",
          icon: <SiSocketdotio className="text-blue-400" />,
        },
        {
          name: "TypeScript",
    ...
    },
    {
      ...
      description:
        "A scalable stock management platform built with Next.js, React.js, Express.js, and SQL. Features include real-time data handling, API integration, and optimized user experience through server-side rendering.",
      technologies: [
      ...
      features: [
        ...
        "Efficient RESTful API development",
        "Frontend optimization with SSR and incremental static regeneration",
        "User authentication and role-based access",
        "Stock portfolio management",
        "Search and filtering of stocks",
        "Performance monitoring and analytics",
      ],
      highlights: [
        "Built and maintained scalable RESTful APIs using Express.js to integrate frontend and backend",
        "Migrated frontend codebase from React to Next.js to improve SEO and page load performance",
        "Utilized Next.js features such as automatic static optimization and incremental static regeneration",
        "Collaborated with senior developers to optimize API performance and design a robust database schema",
        "Implemented structured sprint planning using Azile for effective project management",
        "Worked on multiple modules within the stock management system",
      ],
      website: "https://www.sharesanskar.com",
    },
    {
      title: "Laliguras Hiking Platform",
      description:
        "A comprehensive hiking platform where users can book tour guides, lodges, and explore hiking locations through interactive maps.",
      technologies: [
      ...
      highlights: [
        "Implemented interactive maps with ArcGis",
    ...
    },
    {
      ...
      description:
        "A real-time chat and video call application backend built with NestJS, featuring WebSocket communication, video call functionality, and message queuing.",
      technologies: [
        { name: "NestJS", icon: <SiNestjs className="text-red-600" /> },
        {
          name: "PostgreSQL",
    ...
    },
    {
      ...
      description:
        "A comprehensive food delivery system built with microservices architecture using TCP communication between components.",
      technologies: [
        { name: "NestJS", icon: <SiNestjs className="text-red-600" /> },
      ...
      githubLink: "https://github.com/roshankc00/Food_delivery_system",
    },
    {
      title: "Mero Bazar - E-commerce CMS",
      description:
        "A sophisticated multi-vendor e-commerce CMS platform built with modern technologies. Features comprehensive product management, user tracking, and sales analytics.",
      technologies: [
        { name: "NestJS", icon: <SiNestjs className="text-red-600" /> },
      ...
      githubLink: "https://github.com/roshankc00/Mero-Bazar",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div data-aos="fade-up" className="text-center mb-12">
          ...
          <p className="text-gray-300">
            Showcasing my backend development expertise
          </p>
        </div>
