...
const Projects: React.FC = () => {
  ...
  const projects: Project[] = [
    ...
    },
    {
      ...
      description:
        "A comprehensive Learning Management System similar to Udemy, built with NestJS and AWS services. Features include course management, video streaming, and real-time notifications.",
      technologies: [
        { name: "NestJS", icon: <SiNestjs className="text-red-600" /> },
        {
          name: "PostgreSQL",
